...
def per_trade_summary (input_df) :
...
if __name__ == "__main__":
    ...
    overall_summary(per_trade_summary(trading_strategy(buy_sell_analysis_input_dataset("nvda_1m_01-may-2023_to_01-june-2023_regular_hours.csv"))))